...
We have quite a few utilities-first CSS framework like [Tailwind CSS](https://tailwindcss.com/), [Windi CSS](https://windicss.org/) and [Tachyons](https://tachyons.io/), etc.
...
Let's take a look at how atomic CSS works.
...
The traditional way not only costs you unnecessary computation (generated by not in use) but is also unable to satisfy your needs that are not included in the first place.
...
Other than the independent generator core, UnoCSS intentionally only provides Vite plugin (might consider other integrations later) which allows it to focus on the best possible integration with Vite.
...
Please feel free to comment or retweet [this tweet](TODO) letting me know what you think! 🙌
