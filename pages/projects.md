...
projects:
  Current Focus:
    - name: 'Devframe'
      ...
      desc: 'Framework-neutral foundation for building generic DevTools'
      icon: 'devframe'
    - name: 'Vite DevTools'
  ...
  Vite Ecosystem:
    ...
    - name: 'vite-plugin-vue-tracer'
      link: 'https://github.com/antfu/vite-plugin-vue-tracer'
      desc: 'Trace elements and vdoms back to the source code in Vue SFC'
  ...
  TypeScript:
    ...
    - name: 'tsnapi'
      link: 'https://github.com/antfu/tsnapi'
      desc: 'Public API snapshot testing for runtime exports and type declarations'
  ...
  Utilities:
    ...
    - name: 'magic-string'
      ...
      desc: 'Manipulate strings like a wizard. (Maintainer)'
      icon: 'i-ph-magic-wand-duotone'
    - name: 'nanovis'
      link: 'https://github.com/antfu/nanovis'
      desc: 'Tiny visualization library for tree structures in Treemap, Sunburst, Flame'
      icon: 'i-carbon-chart-treemap'
    - name: 'whenexpr'
      link: 'https://github.com/antfu/whenexpr'
      desc: 'Tiny when-clause expression evaluator with full type-safety'
      icon: 'i-carbon-decision-tree'
    - name: 'fast-npm-meta'
      link: 'https://github.com/antfu/fast-npm-meta'
      desc: 'A lightweight API server to get npm package metadata'
      icon: 'i-simple-icons-npm'
    - name: 'tsdown-stale-guard'
      link: 'https://github.com/antfu-collective/tsdown-stale-guard'
      desc: 'Build freshness validation for tsdown'
  ...
  CLI:
    ...
    - name: 'changelogithub'
      link: 'https://github.com/antfu-collective/changelogithub'
      desc: 'Generate changelog for GitHub releases'
      icon: 'i-carbon-catalog'
    - name: 'ghfs'
      link: 'https://github.com/antfu/ghfs'
      desc: 'GitHub issues/PRs as filesystem, for human and agents'
      icon: 'i-carbon-folder-details'
    - name: 'pnpm-workspace-utils'
      link: 'https://github.com/antfu/pnpm-workspace-utils'
      desc: 'Utilities for managing pnpm catalogs'
